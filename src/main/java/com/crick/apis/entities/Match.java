...
public class Match {
    ...
    private String battingTamScore;
    ...
    public Match(int matchId, String teamHeading, String matchNumberVenue, String battingTeam, String battingTamScore, String bowlTeam, String bowlTeamScore, String liveText, String matchLink, String textComplete, MatchStatus status, Date date) {
        this.matchId=matchId;
        this.teamHeading=teamHeading;
        this.matchNumberVenue=matchNumberVenue;
        this.battingTeam = battingTeam;
        this.battingTamScore=battingTamScore;
    ...
    public String getBattingTamScore() {
        return battingTamScore;
    }

    public void setBattingTamScore(String battingTamScore) {
        this.battingTamScore = battingTamScore;
    }
